    ...
    <section id="experience" className="py-24 px-6 md:px-16 bg-background">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-10">
          {experiences.map((exp) => (
            <div key={exp.role} className="border-l-2 border-primary/30 pl-6 relative">
              ...
              <ul className="space-y-2">
                {exp.highlights.map((h, i) => (
                  <li key={i} className="text-muted-foreground text-sm font-light leading-relaxed flex gap-2">
